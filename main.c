...
void main()
{
    ...
    insert(&main, 2.3, "Curd Rice", 1, 350);
    insert(&main, 2.4, "Veg Sizzler", 1, 250);
    insert(&main, 2.5, "Margherita Pizza", 1, 200);
    insert(&main, 2.6, "Barbeque Chicken Pizza", 1, 250);
    insert(&main, 2.7, "Chicken Burger", 1, 150);
    insert(&main, 2.8, "Barbeque chichen half", 1, 250);
    insert(&main, 2.9, "Chicken Biryani", 1, 250);
    insert(&dess, 3.1, "Chocolate Overload Waffle", 1, 150);
    insert(&dess, 3.2, "ChocoNut cake", 1, 50);
                    ...
                    case 2:
                        ...
                        switch(ch)
                        {
                            case 1: printf("\nEnter Food Code:\n");
                                    ...
                                    printf("\nEnter price:\n");
                                    scanf("%f", &price);
                                    insert(&side, fcu, fnameu, 1, price);
                                    printf("\nMENU UPDATED\n");
                                    foodlist(&side);
                                    break;
                            case 2: printf("\nEnter Food Code:\n");
                                    ...
                                    printf("\nEnter price:\n");
                                    scanf("%f", &price);
                                    insert(&main, fcu, fnameu, 1, price);
                                    printf("\nMENU UPDATED\n");
                                    foodlist(&main);
                                    break;
                            case 3: printf("\nEnter Food Code:\n");
                                    ...
                                    printf("\nEnter price:\n");
                                    scanf("%f", &price);
                                    insert(&dess, fcu, fnameu, 1, price);
                                    printf("\nMENU UPDATED\n");
                                    foodlist(&dess);
                                    break;
